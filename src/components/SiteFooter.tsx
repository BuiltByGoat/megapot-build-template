  ...
  return (
    <footer className="site-footer wrap">
      <p>
        ...
        sites; this hub is not a player landing. It is not operated by, affiliated with, or
        endorsed by Megapot. Play and payouts happen on megapot.io. The Network hub is{' '}
