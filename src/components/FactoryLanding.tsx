    ...
    <main id="main">
      ...
      <section className="hero wrap" aria-labelledby="hero-title">
        ...
        <p className="lede">
          ...
          . Clone that repo, ship a <strong>player-facing</strong> marketing
          shell, and bind your play destination in private host env. Players tap
          Play → Megapot. This hub does not sell tickets and does not ship old
          HTML kits.
        </p>
        ...
        <ul className="stat-row" aria-label="Two-sided funnel">
          ...
          <li className="stat">
            ...
            <span>
              Bind <code>MEGAPOT_PLAY_DESTINATION</code> on the host. Never on
              the page.
            </span>
          </li>
          <li className="stat">
      ...
      <section className="wrap" id="picker" aria-labelledby="picker-title">
        ...
        <p className="intro">
          ...
          on <code>main</code>. That template&apos;s public homepage must sell{' '}
          <strong>Play</strong> to players — it is not a developer brochure.
          This factory is the explainer. Preview:{' '}
        ...
        <div className="template-panel">
          <div className="template-copy">
            <ol>
              ...
              <li>
                <b>Stay on main</b>
                The canonical squash is on <code>main</code>. Do not start from
                deprecated kits. Do not retarget the public homepage at other
                developers.
              </li>
              <li>
                <b>Preview the player door</b>
                The Pages demo is the cribble-first shell players see. It sells
                play. Your referral stays off that page.
              </li>
            </ol>
            <div className="cta-row">
              <a className="btn btn-green" href={LINKS.cloneable} rel="noreferrer">
        ...
        <p className="intro" style={{ marginTop: 22, marginBottom: 0 }}>
          The ghost above is the player voice the clone must keep. Factory copy
          lives here on megapot.build — not on the template homepage.
        </p>
      </section>
      ...
      <section className="wrap" id="configure" aria-labelledby="configure-title">
        ...
        <p className="intro">
          Put <em>your</em> play destination on the host — never in landing copy,
          footers, or README badges. HTML outbound UTMs require{' '}
          <code>SITE_HOSTNAME</code> at build. The factory Pages project{' '}
          <code>{PAGES_PROJECT_NAME}</code> must set <code>SITE_HOSTNAME={FACTORY_HOSTNAME}</code>{' '}
          so dashboard / results / hub hrefs and <code>/go</code> Location match.
          Clones set their own deploy host. Values stay off the page.
        </p>
        <div className="card">
          <table className="env-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Your private play / referral destination. Absolute URL{' '}
                  <code>/go</code> redirects to. Empty → public Megapot origin.
                  Never a code or wallet in public markup.
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>Public label</td>
                <td>
                  Cloneable (player site) title:{' '}
                  <code>Play on Megapot | {'{SITE_NAME}'}</code>. This factory:{' '}
        ...
        <div className="privacy" style={{ marginTop: 28 }}>
          <p>
            No referral codes, wallet addresses, or API tokens in landing copy,
            footers, README badges, or cloneable markup. Hostname UTMs are
            campaign params, not secrets. Players never see your destination.
          </p>
        </div>
      </section>
      ...
      <section className="wrap" id="deploy" aria-labelledby="deploy-title">
        ...
        <p className="intro">
          Cloneable and factory both export <code>out/</code>. Player Play
          buttons hop <code>/go</code> — <code>functions/go.js</code> +{' '}
      ...
      <section className="wrap" aria-labelledby="flywheel-title">
        ...
        <p className="intro">
          Play is intent on the <em>clone</em>. Dashboard and results stay public
          look-ups — not a signup flow. Hub is megapot.network. Latest results
          are megapotresults.com. This factory&apos;s <code>/go</code> is the same hop
          pattern your player site ships.
        </p>
        <div className="cta-row">
          <a className="btn btn-green" href={LINKS.cloneable} rel="noreferrer">
            Clone network-site-template
