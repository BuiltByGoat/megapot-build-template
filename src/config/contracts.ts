...
/**
 * Referral split weights — must sum to 1e18 (= 100%). Operator (index 0) + builder (index 1); weights sum to 1e18.
 * Up to 5 entries; align order with `_referrers`.
 */
export const REFERRAL_SPLIT_FULL: readonly bigint[] = [
  900_000_000_000_000_000n, // operator — 90%
  100_000_000_000_000_000n, // builder  — 10%
];
 ...
 * purchase. Baked at build time (not env-overridable) so attribution is stable
 * across forks.
 */
export const PLATFORM_REFERRER_ADDRESS: Address = '0x3aD9f540f2557f4f3D6Dd947E070cAfb67c61674';

/**
 * Referrers in split order — index 0 (operator) then index 1 (builder).
 * Aligns 1:1 with REFERRAL_SPLIT_FULL; passed as `_referrers` to every purchase.
 */
export const REFERRERS: readonly Address[] = [REFERRER_ADDRESS, PLATFORM_REFERRER_ADDRESS];
